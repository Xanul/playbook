...
// Usando el index del callback
const indexNumber = numbers4.map(function (_,index) {
    return index
})
console.log("Imprimiendo la lista del index del arreglo")
console.log(indexNumber)

// Usando el array del callback
const arrayNumber = numbers4.map(function (_,_,array){
    return array
})

console.log("Imrimiendo el arreglo entero")
